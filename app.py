...
# ─────────────────────────────────────────────
# BASE DE DONNÉES JSON SUR GITHUB
# ─────────────────────────────────────────────
...
def _github_repo() -> str:
    return st.secrets["GITHUB_REPO"]  # ex: "joelachi2025/cooparchive"

def _github_branch() -> str:
    return st.secrets.get("GITHUB_BRANCH", "main")

def _github_db_path(filename: str) -> str:
...
def db_write(table: str, data: list) -> None:
    ...
    _github_put_file(filename, data, sha)
